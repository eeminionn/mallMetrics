...
urlpatterns = [
    ...
    path("analyses/<uuid:pk>/insights/force-ai-video-quality/", views.force_ai_video_quality, name="force_ai_video_quality"),
    path("analyses/<uuid:pk>/insights/force-ai-layout/", views.force_ai_layout, name="force_ai_layout"),
    ...
    path("reports/analysis/<uuid:pk>/executive.pdf", views.download_executive_pdf, name="download_executive_pdf"),
    path("reports/analysis/<uuid:pk>/executive.pptx", views.download_executive_pptx, name="download_executive_pptx"),
    path("reports/mall/<int:pk>/download/", views.download_mall_report, name="download_mall_report"),
    path("reports/mall/<int:pk>/executive.pdf", views.download_mall_executive_pdf, name="download_mall_executive_pdf"),
    path("reports/mall/<int:pk>/executive.pptx", views.download_mall_executive_pptx, name="download_mall_executive_pptx"),
]
